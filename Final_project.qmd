...
subtitle: "Predicting crop yields using weather data, using supervised machine learning."
...
XXXXX Introduction to project

# Data

XXXXX Description of data

# Pre-analysis data merging and cleaning
Loading in packages
...
state_corn_map<-
  ...
  scale_fill_gradient2(low="#F7E594",
                       ...
                       label = scales::comma)+
  labs(title="State Corn Harvest  in the United States (2017)", 
...
state_drought_map<-
  ...
  scale_fill_gradient2(low="white",
                       ...
                       name = "Drought Index\nAnnual Average",
                       label = scales::comma)+
  labs(title="State Drought Index Averages in the United States (2017)",
       caption = "Data Source: University of Nebraska-Lincoln, 2017,")+
  theme(legend.position = "right",
        panel.background=element_rect(colour = "black", fill = "white"), 
        plot.title = element_text(face="bold"))
...
state_aq_map<-
  ...
  scale_fill_gradient2(low="#F7E594",
                       ...
                       high="red",
                       na.value="white",
                       name = "State AQ Averages",
                       label = scales::comma)+
  labs(title="States with Unhealthy AQ in the United States (2017)", 
       caption = "Data Source: Environmental Protection Agency, 2017")+
  theme(legend.position = "right",
        panel.background=element_rect(colour = "black", fill = "white"), 
        plot.title = element_text(face="bold"))
...
# Modeling: Predicting corn yields with weather data
...
subtitle = "This plot shows the variables in our data based on their importance in predicting corn yield with our model.",
y = "Importance",
x = "Variables")+
